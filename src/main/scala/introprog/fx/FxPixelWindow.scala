...
/** A window with a canvas for pixel-based drawing implemented using JavaFX.
  *
...
class PixelWindow(
  val width: Int = 800,
  val height: Int = 640,
  val title: String      = "fx.PixelWindow",
  ...
  protected val queueCapacity = 1000
  protected var eventQueue =
    new java.util.concurrent.LinkedBlockingQueue[javafx.event.Event](queueCapacity)
